...
public class Oura1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oura1);
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#FF6200EE")));
        getSupportActionBar().setTitle("1 Day Readiness Predictions");
    ...
    private void readOuraData() {
        ...
        InputStream is = getResources().openRawResource(R.raw.ouraring1);
