...
public class oura7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oura7);
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#FF6200EE")));
        getSupportActionBar().setTitle("7 Day Readiness Predictions");
    ...
    private void readOuraData() {
        ...
        InputStream is = getResources().openRawResource(R.raw.ouraring7);
